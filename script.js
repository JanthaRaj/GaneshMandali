...
function optimizePerformance(){let scrollTimeout;const originalScrollHandler=window.onscroll;window.onscroll=function(){if(scrollTimeout){clearTimeout(scrollTimeout);}
scrollTimeout=setTimeout(()=>{if(originalScrollHandler){originalScrollHandler();}},16);};const criticalImages=['assets/images/shivaji_maharaj_portrait.jpg','assets/images/lord_ganesha_idol.jpg'];criticalImages.forEach(src=>{const img=new Image();img.src=src;});}
optimizePerformance();
